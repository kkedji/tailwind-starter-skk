...
interface AnalyseHistoriquePageProps {
    formData: CreditApplicationData;
    setFormData: (updateFn: (prev: CreditApplicationData) => CreditApplicationData) => void;
    onNext: () => void;
}

const AnalyseHistoriquePage: React.FC<AnalyseHistoriquePageProps> = ({ formData, setFormData, onNext }) => {
    const sectionKey: keyof AnalyseData = 'historique';
...
export default AnalyseHistoriquePage;
