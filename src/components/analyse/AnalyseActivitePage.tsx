...
interface AnalyseActivitePageProps {
    formData: CreditApplicationData;
    setFormData: (updateFn: (prev: CreditApplicationData) => CreditApplicationData) => void;
    onNext: () => void;
}

const AnalyseActivitePage: React.FC<AnalyseActivitePageProps> = ({ formData, setFormData, onNext }) => {
    const sectionKey: keyof AnalyseData = 'activite';
...
export default AnalyseActivitePage;
