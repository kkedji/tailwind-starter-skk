...
interface AnalyseEntreprisePageProps {
    formData: CreditApplicationData;
    setFormData: (updateFn: (prev: CreditApplicationData) => CreditApplicationData) => void;
    onNext: () => void;
}

const AnalyseEntreprisePage: React.FC<AnalyseEntreprisePageProps> = ({ formData, setFormData, onNext }) => {
    const sectionKey: keyof AnalyseData = 'entreprise';
...
export default AnalyseEntreprisePage;
