...
interface AnalyseCashFlowPageProps {
    formData: CreditApplicationData;
    setFormData: (updateFn: (prev: CreditApplicationData) => CreditApplicationData) => void;
    onNext: () => void;
}

const AnalyseCashFlowPage: React.FC<AnalyseCashFlowPageProps> = ({ formData, setFormData, onNext }) => {
    const sectionKey: keyof AnalyseData = 'cashFlow';
...
export default AnalyseCashFlowPage;
